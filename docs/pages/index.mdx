...
Run quantized small language models directly in the browser with WebGPU, featuring built-in support for agentic workflows.

## Features

- 🚀 **Flexible Inference** - Run models on-device or via cloud providers
- ⚡ **WebGPU Acceleration** - Leverage WebGPU for high-performance on-device inference
